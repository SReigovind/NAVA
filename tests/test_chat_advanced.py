"""Advanced chat, RAG routing, and memory qualitative test.

Run from project root:  python tests/test_chat_advanced.py
Run from tests/:        python test_chat_advanced.py
...
def test_chat_advanced():
    ...
    report_path = MARKDOWN_OUT_DIR / "chat_report.md"
    ...
    with TestClient(app) as client:
        with patch.object(ChatClient, 'send', new=spy_send), \
            ...
            res = client.post("/api/auth/login", json={"email": "test@gmail.com", "password": "123456789"})
            ...
            with open(report_path, "w") as md:
                ...
                # Step 6 — dummy messages to trigger summariser
